...
export const dict: Record<string, string> = {
  ...
  "ach.rankMatros.desc": "Alcanza el rango Матрос.",
  "ach.rankMichman.title": "Vía de oficial",
  "ach.rankMichman.desc": "Alcanza el rango Мичман.",
  "ach.rankLieutenant.title": "Puente de mando",
  "ach.rankLieutenant.desc": "Alcanza el rango Лейтенант.",
  "ach.rankAdmiral.title": "Almirante de la flota",
  "ach.rankAdmiral.desc": "Alcanza el rango Адмирал.",
