...
export const dict: Record<string, string> = {
  ...
  "ach.rankMatros.desc": "Alcance o rank Матрос.",
  "ach.rankMichman.title": "Carreira de oficial",
  "ach.rankMichman.desc": "Alcance o rank Мичман.",
  "ach.rankLieutenant.title": "Ponte de comando",
  "ach.rankLieutenant.desc": "Alcance o rank Лейтенант.",
  "ach.rankAdmiral.title": "Almirante da frota",
  "ach.rankAdmiral.desc": "Alcance o rank Адмирал.",
