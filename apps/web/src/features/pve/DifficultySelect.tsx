    ...
    <div className="mx-auto w-full max-w-3xl space-y-6">
      <header className="space-y-2 text-center">
        ...
        <p className="mx-auto max-w-xl text-sm text-sea-300">
          PvE matches pay a micro-stake and award Abstract XP. Stakes are the platform's cut;
          win or lose, you earn XP on a win.
        </p>
      </header>
        ...
        {OPTIONS.map(({ value, blurb }) => (
          <li key={value}>
            <button
              ...
              className="group flex h-full w-full flex-col items-start gap-3 rounded-2xl border border-sea-700/60 bg-sea-900/60 p-5 text-left transition hover:border-sea-400 hover:bg-sea-800/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sea-300"
            >
